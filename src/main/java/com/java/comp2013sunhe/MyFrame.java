...
public class MyFrame extends JPanel implements KeyListener
{
	...
	public MyFrame()
	{
//		jFrame.setIconImage(java.awt.Toolkit.getDefaultToolkit()
//				.getImage(getClass().getResource("/com.java.comp2013sunhe/img/Kukulkan-snake-head-right.png").getFile()));
		jFrame.setIconImage(ImageUtil.images.get("logo"));
	}
